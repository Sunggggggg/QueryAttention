...
# python experiment_scripts/train_realestate10k.py --experiment_name realestate_query --batch_size 4 --gpus 2 --contra --lpips --depth
...
p.add_argument('--contra', action='store_true', default=False)
p.add_argument('--model', type=str, default='query')
